...
func (s *Service) listEksPodIdentities(eksClusterName string) ([]*eks.PodIdentityAssociationSummary, error) {
	...
	output, err := s.EKSClient.ListPodIdentityAssociations(input)
	if err != nil {
